...
func (uc *UserCreate) SetParentID(s string) *UserCreate {
	uc.mutation.SetParentID(s)
	return uc
}
...
func (uc *UserCreate) SetModTime(t time.Time) *UserCreate {
	uc.mutation.SetModTime(t)
	return uc
}
...
func (uc *UserCreate) check() error {
	if _, ok := uc.mutation.ParentID(); !ok {
		return &ValidationError{Name: "parent_id", err: errors.New(`ent: missing required field "User.parent_id"`)}
	}
	...
	if _, ok := uc.mutation.ModTime(); !ok {
		return &ValidationError{Name: "mod_time", err: errors.New(`ent: missing required field "User.mod_time"`)}
	}
	return nil
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.ParentID(); ok {
		_spec.SetField(user.FieldParentID, field.TypeString, value)
	...
	if value, ok := uc.mutation.ModTime(); ok {
		_spec.SetField(user.FieldModTime, field.TypeTime, value)
		_node.ModTime = value
	}
	return _node, _spec
}
