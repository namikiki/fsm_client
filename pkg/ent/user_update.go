...
func (uu *UserUpdate) SetParentID(s string) *UserUpdate {
	uu.mutation.SetParentID(s)
	return uu
}
...
func (uu *UserUpdate) SetModTime(t time.Time) *UserUpdate {
	uu.mutation.SetModTime(t)
	return uu
}
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.ModTime(); ok {
...
// SetParentID sets the "parent_id" field.
func (uuo *UserUpdateOne) SetParentID(s string) *UserUpdateOne {
	uuo.mutation.SetParentID(s)
	return uuo
}
...
// SetModTime sets the "mod_time" field.
func (uuo *UserUpdateOne) SetModTime(t time.Time) *UserUpdateOne {
	uuo.mutation.SetModTime(t)
	return uuo
}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.ModTime(); ok {
		_spec.SetField(user.FieldModTime, field.TypeTime, value)
	}
