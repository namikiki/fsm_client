...
// The DirFunc type is an adapter to allow the use of ordinary
// function as Dir mutator.
type DirFunc func(context.Context, *ent.DirMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DirFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DirMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.DirMutation", m)
}
